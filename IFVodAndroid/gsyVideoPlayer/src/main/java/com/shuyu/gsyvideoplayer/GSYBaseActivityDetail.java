 ...
 */
public abstract class GSYBaseActivityDetail<T extends GSYBaseVideoPlayer> extends BaseActivity implements VideoAllCallBack {
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        boolean isFullScreen = savedInstanceState.getBoolean("is_full_screen", false);
        getGSYVideoPlayer().setIfCurrentIsFullscreen(isFullScreen);
        if (isFullScreen) {
            getGSYVideoPlayer().startWindowFullscreen(GSYBaseActivityDetail.this, hideActionBarWhenFull(), hideStatusBarWhenFull());
        }
    }
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean("is_full_screen", getGSYVideoPlayer().isIfCurrentIsFullscreen());
    }
...
//        getGSYVideoPlayer().getCurrentPlayer().onVideoResume();
    ...
    @Override
    public void onVideoSizeChanged(int width, int height, Object... objects) {
        if (orientationUtils == null) {
            throw new NullPointerException("initVideo() or initVideoBuilderMode() first");
        }
        //加载第一帧后才能确定是否开启旋转，竖屏视频不能旋转
