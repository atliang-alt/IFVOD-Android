...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    public void onCompletion() {
        ...
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onComplete(mOriginUrl, mTitle, this, mCurrentPosition);
        }
    ...
    public void onVideoSizeChanged() {
        ...
        if (mVideoAllCallBack != null) {
            mVideoAllCallBack.onVideoSizeChanged(mVideoWidth, mVideoHeight, this);
        }
    }
    ...
    public boolean isInPlayingState() {
        return mCurrentState > 0 && mCurrentState != CURRENT_STATE_AUTO_COMPLETE && mCurrentState != CURRENT_STATE_ERROR;
    }
