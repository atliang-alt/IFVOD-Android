        ...
        getGSYADVideoOptionBuilder()
                .setVideoAllCallBack(new GSYSampleCallBack() {
                    ...
                    public void onAutoComplete(String url, Object... objects) {
                        ...
                        GSYBaseADActivityDetail.this.onAutoComplete(url, objects);
                    }
...
//        GSYVideoADManager.onResume();
    ...
    protected boolean isADStarted() {
        return getGSYADVideoPlayer().getCurrentPlayer().VISIBLE == View.VISIBLE && getGSYADVideoPlayer().getCurrentPlayer().getCurrentState() >= 0 &&
