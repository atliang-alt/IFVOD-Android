...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected void onClickUiToggle(MotionEvent e) {
        if (mIfCurrentIsFullscreen && mLockCurScreen && mNeedLockFull) {
            if (e.getAction() == MotionEvent.ACTION_UP) {
                if (mLockScreen.getVisibility() == VISIBLE) {
    ...
    protected void changeUiToNormal() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToNormal");
        ...
        setViewShowState(mLockScreen, (mIfCurrentIsFullscreen && mNeedLockFull) ? VISIBLE : INVISIBLE);
    ...
    protected void changeUiToPreparingShow() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPreparingShow");
...
//        setViewShowState(mLockScreen, GONE);
    ...
    protected void changeUiToPlayingShow() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPlayingShow");
    ...
    protected void changeUiToPauseShow() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPauseShow");
    ...
    protected void changeUiToPlayingBufferingShow() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPlayingBufferingShow");
...
//        setViewShowState(mLockScreen, GONE);
    ...
    protected void changeUiToCompleteShow() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToCompleteShow");
    ...
    protected void changeUiToError() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToError");
    ...
    protected void changeUiToPrepareingClear() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPrepareingClear");
...
//        setViewShowState(mLockScreen, INVISIBLE);
    ...
    protected void changeUiToPlayingClear() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPlayingClear");
        changeUiToClear();
        setViewShowState(mBottomProgressBar, VISIBLE);
    }

    protected void changeUiToPauseClear() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPauseClear");
        changeUiToClear();
        setViewShowState(mBottomProgressBar, VISIBLE);
        updatePauseCover();
    }
    ...
    protected void changeUiToPlayingBufferingClear() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToPlayingBufferingClear");
...
//        setViewShowState(mLockScreen, INVISIBLE);
    ...
    protected void changeUiToClear() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToClear");
...
//        setViewShowState(mLockScreen, INVISIBLE);
    ...
    protected void changeUiToCompleteClear() {
        Debuger.printfLog(getClass().getSimpleName() + "==changeUiToCompleteClear");
