...
import static com.cqcsy.barcode_scan.view.ViewfinderView.FrameGravity.CENTER;
...
public class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        isFullScreen = array.getBoolean(R.styleable.ViewfinderView_isFullScreen, false);
