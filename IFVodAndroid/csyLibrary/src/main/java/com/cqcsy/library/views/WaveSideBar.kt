...
class WaveSideBar @JvmOverloads constructor(
    ...
    private var mIndexItems: MutableList<String>
    /**
    ...
    fun addIndexItems(position: Int, indexItem: String) {
        mIndexItems.add(position, indexItem)
        requestLayout()
    }

    fun setIndexItems(indexItems: MutableList<String>) {
        mIndexItems.clear()
        mIndexItems.addAll(indexItems)
        requestLayout()
    }
    ...
    companion object {
        ...
        private val DEFAULT_INDEX_ITEMS = arrayListOf(
            "A", "B", "C", "D", "E", "F", "G", "H", "I",
